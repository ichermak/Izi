...
585,"Template"
564,
565,"s_r_w5rXxJ:Csmt_l6gaXv9xgJWFtwsI9@FbCvs0lHalmE6b]OwJQ<]0cmBKfMyWa`LK2e0DHq?6jIndfqVXKpYsivT1ffiNHFpD5bJ@TbV\>9`pl9EYKvM`CLG;?Vh[uE?RtmqD<srN9wAM]K0YZlyV;ai^5TF=:ybhCpjOCfmrsCDPFi?WcVbe1`:F[C^[;DphS]cg"
559,1
928,0
593,
594,
...
pDebugMode,0
pCube,"CubeName"
pMappingElement,"DimName1 : SourceElement-> TargetElement &    DimName2: SourceElement  ->TargetElement"
pMappingDelimiter,"&"
pDimensionDelimiter,":"
pElementDelimiter,"->"
pSkipRuleValues,0
...
pMappingElement,"[Required] Map source elements to target elements using format DimName1:SourceElement->TargetElement & DimName2:SourceElement->TargetElement"
...
# ====================================================================================================
# Description : Copy all data in a given cube using the specified mapping to determine source and target
#
# Parameters : 
# 	- pDebugMode : [Optional] 0 = Nothing | 1 = Write to server message log | 2 = 1 + Keep temporary objects
# 	- pCube : [Required] Target cube name
# 	- pMappingElement : [Required] Map source elements to target elements using format DimName1:SourceElement->TargetElement & DimName2:Source Element->TargetElement
# 	- pMappingDelimiter : [Optional] Delimiter between mapping specifications in pMappingElement
# 	- pDimensionDelimiter : [Optional] Delimiter between dimensions names and source elements in pMappingElement
# 	- pElementDelimiter : [Optional] Delimiter between source elements and target elements in pMappingElement
# 	- pSkipRuleValues : [Optional] 0 = Nothing | 1 = Skip rule values in source view
...
#
# Updates :
# 	- 2019/11/27 - ICH (www.linkedin.com/in/ichermak) : Creation 
# ====================================================================================================
...
# *** Target settings
# ****************************************
cOldLoggingValue = CellGetS('}CubeProperties', cTargetCube, 'LOGGING');
...
# ====================================================================================================
CellPutS(cOldLoggingValue, '}CubeProperties', cTargetCube, 'LOGGING');
